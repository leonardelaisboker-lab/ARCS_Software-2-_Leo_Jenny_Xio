...
MARKER_SIZE_MM = 32  # Physical marker size
CUBE_SIZE_MM = 40    # Physical cube size
...
DBSCAN_EPS = 0.05         # 10mm clustering for object separation
DBSCAN_MIN_POINTS = 1000   # Minimum points to form a cluster
...
objects_pcd = objects_pcd.voxel_down_sample(voxel_size=0.005)
print(f"Reduced to {len(objects_pcd.points)} points")
